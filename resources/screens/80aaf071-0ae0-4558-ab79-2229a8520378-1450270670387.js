jQuery("#simulation")
  .on("click", ".s-80aaf071-0ae0-4558-ab79-2229a8520378 .click", function(event, data) {
  ...
  .on("focusin", ".s-80aaf071-0ae0-4558-ab79-2229a8520378 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-80aaf071-0ae0-4558-ab79-2229a8520378 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
